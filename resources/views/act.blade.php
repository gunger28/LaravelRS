...
@if(count($users) == 0)
    <form method="get" action="{{ route('addNote') }}" style="width: 50%; margin: 0 auto">
        ...
        {{--    <input type="text" class="form-control" id="s" name="s" placeholder="status" style="margin-bottom: 5px;">--}}
...
<input type="hidden" name="id" value="{{$users[0]->id}}">
        <input type="text" class="form-control" id="e" name="e" value="{{$users[0]->email}}" style="margin-bottom: 5px;">
        <input type="text" class="form-control" id="p" name="p" value="{{$users[0]->password}}" style="margin-bottom: 5px;">
